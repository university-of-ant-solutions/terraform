...
resource "aws_subnet" "public" {
  ...
  tags              = "${merge(var.tags, var.public_subnet_tags, map("Name", format("%s-sn-public-%s", var.name, element(var.azs, count.index))))}"
...
resource "aws_subnet" "private" {
  ...
  tags              = "${merge(var.tags, var.private_subnet_tags, map("Name", format("%s-sn-private-%s", var.name, element(var.azs, count.index))))}"
}
